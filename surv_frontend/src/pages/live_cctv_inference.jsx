        ...
        <div className="liveCCTVWrapper">
            <div className="leftPanel">
                ...
                <div className="headerSection">
                    <h1>Live CCTV Action Inference</h1>
                    <p className="connectYourCctv">
                        Connect your CCTV stream and choose a model to start real-time action recognition. The AI will begin
                        detecting and analyzing human activities from the live feed immediately after inference starts.
                    </p>
                </div>
